...
<form method="post" class="p-4 rounded shadow-sm bg-light">
    <div class="mb-3">
        ...
        <textarea 
            ...
            style="font-family: 'Quintessential', cursive; resize: none; box-shadow: inset 0 0 8px rgba(0, 0, 0, 0.1);"
        ></textarea>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <button id="download-button" class="btn btn-outline-secondary mt-2" style="font-family: 'Quintessential', cursive;">
                    <i class="fas fa-disk"></i> Save for Later
                    </button>
                </div>
            </div>
        </div>
